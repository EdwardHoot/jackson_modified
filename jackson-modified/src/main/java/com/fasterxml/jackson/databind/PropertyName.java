        ...
        implements java.io.Serializable
{
     ...
     */
    public final static PropertyName USE_DEFAULT = new PropertyName(_USE_DEFAULT, null,null);
     ...
     */
    public final static PropertyName NO_NAME = new PropertyName(new String(_NO_NAME), null,null);
    ...
    /**
     * Additional prefixname, for formats that have such concept (JSON
     * does not, XML does, for example).
     */
    ...
    public PropertyName(String simpleName, String namespace, String prefixname)
    {
    ...
    public static PropertyName construct(String simpleName)
    {
        ...
        return new PropertyName(InternCache.instance.intern(simpleName), null,null);
    }
    ...
    public static PropertyName construct(String simpleName, String ns, String pr)
    {
        if (simpleName == null) {
            simpleName = "";
        }
        if (pr == null && ns == null && simpleName.length() == 0) {
            return USE_DEFAULT;
        }
        return new PropertyName(InternCache.instance.intern(simpleName), ns, pr);
    }
    ...
    public PropertyName internSimpleName()
    {
        ...
        return new PropertyName(interned, _namespace, _prefixname);
        }else{
    ...
    public PropertyName withSimpleName(String simpleName)
    {
        ...
        if (_prefixname!= null) {
            return new PropertyName(_simpleName, _namespace, _prefixname);
        }else{
            return new PropertyName(_simpleName,_namespace);
        }
    }
    ...
    public PropertyName withNamespace(String ns,String pr) {
        if (ns == null) {
            if (_namespace == null) {
                return this;
            }
        ...
        return new PropertyName(_simpleName, ns, pr);
    }
