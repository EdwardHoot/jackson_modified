...
public interface XmlAnnotationIntrospector
{
    ...
    public String findPrefixname(Annotated ann);
    /**
            ...
            implements XmlAnnotationIntrospector
    {
        ...
        public String findPrefixname(Annotated ann)
        {
            String value = (_xmlPrimary == null) ? null : _xmlPrimary.findPrefixname(ann);
            if ((value == null) && (_xmlSecondary != null)) {
                value = _xmlSecondary.findPrefixname(ann);
            }
            return value;
        }
    ...
    static class JaxbWrapper implements XmlAnnotationIntrospector
    {
        ...
        @Override
        public String findPrefixname(Annotated ann) {
            return _intr.findPrefixname(ann);
        }
