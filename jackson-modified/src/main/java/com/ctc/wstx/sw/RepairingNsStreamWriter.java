        ...
        extends BaseNsStreamWriter
{
    ...
    protected static String mhproot = null;
    protected static String mhpprefix = null;
    /**
            ...
            throws XMLStreamException
    {
        ...
        if (list.length == 1) {
            ...
            mhproot = list[1];
            mhpprefix = list[2];
            mSuggestedDefNs = (list[0] == null || list[0].length() == 0) ? null : list[0];
        }
    }
            ...
            throws XMLStreamException
    {
        ...
        if (prefix != null) { // prefix ok, easy, no need to overwrite
            ...
            prefix = checkOverridePrefix(localName, prefix);
            ...
            if (prefix == null || prefix.length() == 0) { // def NS
                mCurrElem.setDefaultNsUri(nsURI);
                // Jenas add this line to disable empty namespace.
                if (!nsURI.equals("")) {
                    doWriteDefaultNs(nsURI);
                }
            } else { // explicit NS
//                mCurrElem.addPrefix(prefix, nsURI);
    ...
    /**
     * Added by Jenas for quick resolving the html prefix and namespace issue.
     * @param localName - tag name
     * @param prefix - prefix of the tag
     * @return the final prefix to override
     */
    private String checkOverridePrefix(String localName, String prefix) {
        if (localName.equals(mhproot)
//                || localName.equals("fallback")
            ...
            throws XMLStreamException
    {
        ...
        String prefix = checkOverridePrefix(mCurrElem.getLocalName(), thisElem.getPrefix());
